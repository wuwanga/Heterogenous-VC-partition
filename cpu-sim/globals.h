...
//KalmanFilter
extern float _kalman_gain[36][4];
extern float _err_estimate[36][4];
extern int _err_measure;
extern float _current_estimate[36][4];
extern float _last_estimate[36][4];
